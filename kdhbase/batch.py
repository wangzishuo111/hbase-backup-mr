...
class Batch(object):
    ...
    def __init__(self, table, timestamp=None, batch_size=None,
                 transaction=False, wal=True,attributes={}):
    ...
    def send(self):
        ...
        if self._timestamp is None:
            self._table.connection.client.mutateRows(self._table.name, bms, self._attributes)
        else:
            self._table.connection.client.mutateRowsTs(
                self._table.name, bms, self._timestamp, self._attributes)
